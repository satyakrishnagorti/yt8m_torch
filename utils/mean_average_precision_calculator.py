...
import utils.average_precision_calculator as average_precision_calculator


class MeanAveragePrecisionCalculator(object):
  """This class is to calculate mean average precision."""

  def __init__(self, num_class, filter_empty_classes=True, top_n=None, present_label_ids=None):
    ...
    self._present_label_ids = present_label_ids

    if present_label_ids:
      for _ in range(len(present_label_ids)):
  ...
  def accumulate(self, predictions, actuals, num_positives=None):
    ...
    if self._present_label_ids:
      for i in range(len(self._present_label_ids)):
